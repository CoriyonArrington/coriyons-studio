...
export default async function SecurityPolicyPage({}: LegalPageProps) {
  // Cast to PageRow so TypeScript knows these fields are strings
  ...
  // Narrow content to string before passing into ReactMarkdown
    ...
    <Layout>
      ...
      >
        <Heading as="h1" size="3xl" mb={6}>
          {pageData?.title ?? 'Security Policy'}
        </Heading>
