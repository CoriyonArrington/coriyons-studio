...
// - Fetches and displays all testimonials.
    ...
    return (
      <Layout>
        <Section id="testimonials-error" py={{ base: 16, md: 24 }} textAlign="center">
          <Heading as="h1" size="2xl">Testimonials Not Available</Heading>
...
export async function generateMetadata({ params }: TestimonialsPageProps): Promise<Metadata> {
  ...
  const title = pageData?.title || "Client Testimonials | Coriyon's Studio";
  const description = pageData?.meta_description || "Read what our clients have to say about their experience working with Coriyon's Studio.";
