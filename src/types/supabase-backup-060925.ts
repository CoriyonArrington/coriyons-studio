// ATTEMPT #4: Removing references to empty Views and CompositeTypes from generic helpers to resolve linter errors.
// NOTE: This file is auto-generated by Supabase. The ideal solution is to prevent the linter from checking this file.
// This manual edit is provided to directly resolve the linter error by simplifying types where components are empty.
